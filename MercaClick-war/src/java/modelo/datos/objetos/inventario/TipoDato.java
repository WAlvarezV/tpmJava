...
public class TipoDato implements Cloneable, Serializable {
    ...
    public void setNOMBRE_TIPO(String NOMBRE_TIPOIn) {
          this.NOMBRE_TIPO = NOMBRE_TIPOIn;
    }
    ...
    public boolean hasEqualMapping(TipoDato valueObject) {
          ...
          if (this.NOMBRE_TIPO == null) {
                    if (valueObject.getNOMBRE_TIPO() != null)
                           return(false);
          } else if (!this.NOMBRE_TIPO.equals(valueObject.getNOMBRE_TIPO())) {
                    return(false);
          }
          if (this.CODIGO == null) {
    ...
    public String toString() {
        ...
        out.append("NOMBRE_TIPO = " + this.NOMBRE_TIPO + "\n"); 
    ...
    public Object clone() {
        ...
        if (this.NOMBRE_TIPO != null)
             cloned.setNOMBRE_TIPO(new String(this.NOMBRE_TIPO)); 
        if (this.CODIGO != null)
