...
import java.math.*;
 ...
 /**
  * MedioPago Value Object.
  * This class is value object representing database table MEDIO_PAGO
...
public class MedioPago implements Cloneable, Serializable {
    ...
    public MedioPago (int ID_FACTURAIn) {
    ...
    public void setID_MEDIO_PAGO(int ID_MEDIO_PAGOIn) {
          this.ID_MEDIO_PAGO = ID_MEDIO_PAGOIn;
    }
    ...
    /** 
     * hasEqualMapping-method will compare two MedioPago instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(MedioPago valueObject) {

          if (valueObject.getID_FACTURA() != this.ID_FACTURA) {
                    return(false);
          }
          if (valueObject.getID_MEDIO_PAGO() != this.ID_MEDIO_PAGO) {
                    return(false);
          }
    ...
    public String toString() {
        ...
        out.append("\nclass MedioPago, mapping to table MEDIO_PAGO\n");
        out.append("Persistent attributes: \n"); 
        out.append("ID_FACTURA = " + this.ID_FACTURA + "\n"); 
        out.append("ID_MEDIO_PAGO = " + this.ID_MEDIO_PAGO + "\n"); 
     ...
     */
    public Object clone() {
        MedioPago cloned = new MedioPago();

        cloned.setID_FACTURA(this.ID_FACTURA); 
        cloned.setID_MEDIO_PAGO(this.ID_MEDIO_PAGO); 
