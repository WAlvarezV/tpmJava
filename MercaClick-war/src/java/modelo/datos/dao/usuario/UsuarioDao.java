...
import java.util.*;
import java.math.*;
import modelo.datos.objetos.usuario.Usuario;
...
public class UsuarioDao {
    ...
    public synchronized void create(Connection conn, Usuario valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO USUARIO ( ID_USUARIO, ID_ROL, ID_ESTADO, "
               + "ID_PERSONA, USUARIO, CLAVE, "
               + "ULTIMA_SESION, ANULADO) VALUES (?, ?, ?, ?, ?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);

               stmt.setInt(1, valueObject.getID_USUARIO()); 
               stmt.setInt(2, valueObject.getID_ROL()); 
               stmt.setInt(3, valueObject.getID_ESTADO()); 
               stmt.setInt(4, valueObject.getID_PERSONA()); 
               stmt.setDouble(5, valueObject.getUSUARIO()); 
               stmt.setDouble(6, valueObject.getCLAVE()); 
               stmt.setDate(7, valueObject.getULTIMA_SESION()); 
    ...
    public void save(Connection conn, Usuario valueObject) 
          ...
          String sql = "UPDATE USUARIO SET ID_ROL = ?, ID_ESTADO = ?, ID_PERSONA = ?, "
               + "USUARIO = ?, CLAVE = ?, ULTIMA_SESION = ?, "
               + "ANULADO = ? WHERE (ID_USUARIO = ? ) ";
          PreparedStatement stmt = null;

          try {
              stmt = conn.prepareStatement(sql);
              stmt.setInt(1, valueObject.getID_ROL()); 
              stmt.setInt(2, valueObject.getID_ESTADO()); 
              stmt.setInt(3, valueObject.getID_PERSONA()); 
              stmt.setDouble(4, valueObject.getUSUARIO()); 
              stmt.setDouble(5, valueObject.getCLAVE()); 
              stmt.setDate(6, valueObject.getULTIMA_SESION()); 
              stmt.setInt(7, valueObject.getANULADO()); 

              stmt.setInt(8, valueObject.getID_USUARIO()); 
    ...
    public List searchMatching(Connection conn, Usuario valueObject) throws SQLException {
          ...
          if (valueObject.getID_ROL() != 0) {
              if (first) { first = false; }
              sql.append("AND ID_ROL = ").append(valueObject.getID_ROL()).append(" ");
          }
          ...
          if (valueObject.getULTIMA_SESION() != null) {
              if (first) { first = false; }
              sql.append("AND ULTIMA_SESION = '").append(valueObject.getULTIMA_SESION()).append("' ");
          }
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Usuario valueObject) 
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setID_ROL(result.getInt("ID_ROL")); 
                   valueObject.setID_ESTADO(result.getInt("ID_ESTADO")); 
                   valueObject.setID_PERSONA(result.getInt("ID_PERSONA")); 
                   valueObject.setUSUARIO(result.getDouble("USUARIO")); 
                   valueObject.setCLAVE(result.getDouble("CLAVE")); 
                   valueObject.setULTIMA_SESION(result.getDate("ULTIMA_SESION")); 
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setID_ROL(result.getInt("ID_ROL")); 
                   temp.setID_ESTADO(result.getInt("ID_ESTADO")); 
                   temp.setID_PERSONA(result.getInt("ID_PERSONA")); 
                   temp.setUSUARIO(result.getDouble("USUARIO")); 
                   temp.setCLAVE(result.getDouble("CLAVE")); 
                   temp.setULTIMA_SESION(result.getDate("ULTIMA_SESION")); 
